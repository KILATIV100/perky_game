...
CAFE_MENU_URL = "https://menu.ps.me/ZK6-i-cBzeg"
...
COFFEE_ITEMS = [ 
    ...
    },
    {
        ...
        "button_name": "Brazil Alfenas Dulce (100% арабіка)"
    },
    {
        "id": "coffee_3", 
    ...
    },
    {
        ...
        "button_name": "Italy Blend (100% арабіка)"
    },
    {
        "id": "coffee_5", 
        ...
        "button_name": "GOURMETTO (80% арабіка / 20% робуста)"
    },
]
...
MERCH_ITEMS = [ 
    {
        ...
        "button_name": "Еко чашка з бамбука 'PerkUP' (200 грн)"
    },
    {
        "id": "merch_2", 
        ...
        "button_name": "Футболка 'Coffee Jumper' (350 грн)"
    },
    {
        "id": "merch_3", 
        ...
        "button_name": "Худі 'Coffee Jumper' (1000 грн)"
    },
    {
        "id": "merch_4", 
        ...
        "button_name": "Подарунковий набір 'PerkUP' (2000 грн)"
    },
]
...
class PerkyCoffeeBot:
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        welcome_message = (
            ...
            "Тут можна виграти 🎁 <b>бонуси</b>! Вони видаються за загальну кількість зібраних кавових зерен (☕) у грі:\n"
            "— Знижка 2%: від <b>100</b> зерен\n"
            "— Знижка 5%: від <b>200</b> зерен\n"
            "— ☕ Брендована чашка: від <b>5000</b> зерен\n\n"
    ...
    async def button_callback(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # ЛОГІКА ДЛЯ КАТЕГОРІЙ МАГАЗИНУ - ЯВНА ПЕРЕВІРКА
    ...
    async def show_shop_category(self, query: Update, category: str):
        ...
        keyboard = []
        for item in items:
            # Використовуємо button_name для лаконічності
            button_text = item.get('button_name', f"{item['name']} ({item['price']})") 
